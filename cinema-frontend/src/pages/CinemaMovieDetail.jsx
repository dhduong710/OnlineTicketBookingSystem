                ...
                <div className="movie-header">
                    ...
                    <div className="movie-info-box">
                        ...
                        <div className="detail-description">
                            <p>
                                <strong>Đạo diễn:</strong> {movie.directors && movie.directors.length > 0 
                                    ? movie.directors.map(d => d.name).join(", ") 
                                    : "Đang cập nhật"}
                            </p>
                            <p>
                                <strong>Diễn viên:</strong> {movie.actors && movie.actors.length > 0 
                                    ? movie.actors.map(a => a.name).join(", ") 
                                    : "Đang cập nhật"}
                            </p>
                            <p>
                                <strong>Thể loại:</strong> {movie.genres && movie.genres.length > 0 
